...
export default function ProposalContent({ clientSlug, clientName }: ProposalContentProps) {
  ...
  // Selected commercial package state
  ...
  const getPackageMailto = (pkg: "FOUNDATION" | "GROWTH" | "SCALE") => {
    ...
    const body = encodeURIComponent(
      `Hi Jayant,\n\nI have reviewed the 90-day commercial proposal and would like to choose the ${pkg} package (${prices[pkg]} / 90 days) for ${clientName}.\n\nLet's schedule our confirmation session to align details and confirm direction.\n\nPreferred Days/Times:\n\nRegards,\n${clientName}`
    );
  ...
  const commercialsRef = useRef<HTMLElement>(null);
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = [
        ...
        { id: "commercials", ref: commercialsRef },
  ...
  const navItems = [
    ...
    { label: "Commercial Options", id: "commercials" },
  ...
  return (
    <div className="proposal-page relative min-h-screen bg-[#070A13] text-slate-100 selection:bg-[#C5A880]/20 selection:text-[#C5A880] font-sans antialiased overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#070A13]/85 backdrop-blur-md border-b border-slate-800 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center">
            <button
              onClick={() => scrollToSection("commercials")}
            ...
            >
              <span className="proposal-nav-text">View Commercials</span>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-32 pb-24 flex flex-col gap-24 md:gap-36">
        ...
        {/* ==========================================
            Three-Tier Commercial Proposal Section
            ========================================== */}
        <section ref={commercialsRef} id="commercials" className="border-b border-slate-800/40 pb-20 scroll-mt-24">
          {/* Section Header & Commercial Positioning */}
          <div className="mb-12 text-left">
            ...
            <p className="proposal-body-text text-slate-300 mt-4 max-w-3xl font-light">
          ...
          <div className="mb-16 p-8 rounded-2xl bg-[#0C1225]/60 border border-slate-800/80">
          ...
          <div className="mb-16 p-8 rounded-2xl bg-[#C5A880]/[0.04] border border-[#C5A880]/30 relative overflow-hidden">
          ...
          <div className="p-6 rounded-xl bg-slate-900/30 border border-slate-800 text-left">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8 bg-[#0C1225]/40 border border-slate-800 rounded-3xl p-8 md:p-16">
            ...
            <div className="pt-4 border-t border-slate-800/60">
              <span className="text-xs text-slate-400 block font-mono uppercase tracking-wider">
                Select Package &rarr; Confirm Direction &rarr; Begin 90-Day Execution
              </span>
            </div>
          </div>
        </section>
